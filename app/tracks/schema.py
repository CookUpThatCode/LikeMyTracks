...
class TrackType(DjangoObjectType):
    class Meta:
        model = Track 
        # now TrackType inherits from Track in models.py
...
class Query(graphene.ObjectType):
    ...
    def resolve_tracks(self, info, search=None):
        if search:
            ...
            return Track.objects.filter(filter)   # case insensitive contains
...
class CreateTrack(graphene.Mutation):
    ...
    def mutate(self, info, title, description, url):
        ...
        track.save()                                        # save in the database 
...
class DeleteTrack(graphene.Mutation):
    track_id = graphene.Int()                       # this is the thing you return
